...
all: driver.s funcs
	...
	ld -o $(TARGET) /usr/lib/aarch64-linux-gnu/libc.so driver.o -dynamic-linker /lib/ld-linux-aarch64.so.1 obj/putch.o obj/String_toLowerCase.o obj/string_Substring.o obj/String_Copy.o obj/String_Length.o ../obj/strlength.o ../obj/String_length.o ../obj/putstring.o ../obj/getstring.o ../obj/ascint64.o obj/printContent.o obj/inputInfo.o obj/editInfo.o obj/saveInfo.o obj/searchInfo.o obj/deleteInfo.o

funcs: funcs/printContent.s funcs/inputInfo.s funcs/editInfo.s funcs/saveInfo.s funcs/searchInfo.s funcs/deleteInfo.s funcs/string_Substring.s
